...
def modus(tanaman):
	...
	egp1 = {'penyakit':sortbyfruit_is_eggplant_Aceh.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_Aceh.mode().iloc[0,2]}
	...
	egp2 = {'penyakit':sortbyfruit_is_eggplant_bengkulu.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_bengkulu.mode().iloc[0,2]}

	is_diy = sortbyfruit_is_eggplant['Provinsi']=="DI Yogyakarta"
	sortbyfruit_is_eggplant_diy = sortbyfruit_is_eggplant[is_diy]
	egp3 = {'penyakit':sortbyfruit_is_eggplant_diy.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_diy.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_eggplant['Provinsi']=="Jawa Barat"
	sortbyfruit_is_eggplant_jabar = sortbyfruit_is_eggplant[is_jabar]
	egp4 = {'penyakit':sortbyfruit_is_eggplant_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_jabar.mode().iloc[0,2]}

	is_bali = sortbyfruit_is_eggplant['Provinsi']=="Bali"
	sortbyfruit_is_eggplant_bali = sortbyfruit_is_eggplant[is_bali]
	egp5 = {'penyakit':sortbyfruit_is_eggplant_bali.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_bali.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_eggplant['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_eggplant_jateng = sortbyfruit_is_eggplant[is_jateng]
	egp6 = {'penyakit':sortbyfruit_is_eggplant_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_jateng.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_eggplant['Provinsi']=="Jawa Timur"
	sortbyfruit_is_eggplant_jatim = sortbyfruit_is_eggplant[is_jatim]
	egp7 = {'penyakit':sortbyfruit_is_eggplant_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_jatim.mode().iloc[0,2]}
	...
	egp8 = {'penyakit':sortbyfruit_is_eggplant_kalbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_kalbar.mode().iloc[0,2]}
	...
	egp9 = {'penyakit':sortbyfruit_is_eggplant_kalsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_kalsel.mode().iloc[0,2]}
	...
	egp10 = {'penyakit':sortbyfruit_is_eggplant_kaltim.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_kaltim.mode().iloc[0,2]}

	is_lpg = sortbyfruit_is_eggplant['Provinsi']=="Lampung"
	sortbyfruit_is_eggplant_lpg = sortbyfruit_is_eggplant[is_lpg]
	egp11 = {'penyakit':sortbyfruit_is_eggplant_lpg.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_lpg.mode().iloc[0,2]}

	is_ntb = sortbyfruit_is_eggplant['Provinsi']=="Nusa Tenggara Barat"
	sortbyfruit_is_eggplant_ntb = sortbyfruit_is_eggplant[is_ntb]
	egp12 = {'penyakit':sortbyfruit_is_eggplant_ntb.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_ntb.mode().iloc[0,2]}

	is_sumbar = sortbyfruit_is_eggplant['Provinsi']=="Sumatra Barat"
	sortbyfruit_is_eggplant_sumbar = sortbyfruit_is_eggplant[is_sumbar]
	egp13 = {'penyakit':sortbyfruit_is_eggplant_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_sumbar.mode().iloc[0,2]}

	is_sumut = sortbyfruit_is_eggplant['Provinsi']=="Sumatra Utara"
	sortbyfruit_is_eggplant_sumut = sortbyfruit_is_eggplant[is_sumut]
	egp14 = {'penyakit':sortbyfruit_is_eggplant_sumut.mode().iloc[0,0],'provinsi':sortbyfruit_is_eggplant_sumut.mode().iloc[0,2]}
	...
	bep1 = {'penyakit':sortbyfruit_is_bep_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_bep_jatim.mode().iloc[0,2]}

	is_lpg = sortbyfruit_is_bep['Provinsi']=="Lampung"
	sortbyfruit_is_bep_lpg = sortbyfruit_is_bep[is_lpg]
	bep2 = {'penyakit':sortbyfruit_is_bep_lpg.mode().iloc[0,0],'provinsi':sortbyfruit_is_bep_lpg.mode().iloc[0,2]}
	...
	cp1 = {'penyakit':sortbyfruit_is_cp_bengkulu.mode().iloc[0,0],'provinsi':sortbyfruit_is_cp_bengkulu.mode().iloc[0,2]}

	is_diy = sortbyfruit_is_cp['Provinsi']=="DI Yogyakarta"
	sortbyfruit_is_cp_diy = sortbyfruit_is_cp[is_diy]
	cp2 = {'penyakit':sortbyfruit_is_cp_diy.mode().iloc[0,0],'provinsi':sortbyfruit_is_cp_diy.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_cp['Provinsi']=="Jawa Timur"
	sortbyfruit_is_cp_jatim = sortbyfruit_is_cp[is_jatim]
	cp3 = {'penyakit':sortbyfruit_is_cp_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_cp_jatim.mode().iloc[0,2]}

	is_sumbar = sortbyfruit_is_cp['Provinsi']=="Sumatra Barat"
	sortbyfruit_is_cp_sumbar = sortbyfruit_is_cp[is_sumbar]
	cp4 = {'penyakit':sortbyfruit_is_cp_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_cp_sumbar.mode().iloc[0,2]}
	...
	cb1 = {'penyakit':sortbyfruit_is_cb_kalsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_cb_kalsel.mode().iloc[0,2]}

	is_sumbar = sortbyfruit_is_cb['Provinsi']=="Sumatra Barat"
	sortbyfruit_is_cb_sumbar = sortbyfruit_is_cb[is_sumbar]
	cb2 = {'penyakit':sortbyfruit_is_cb_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_cb_sumbar.mode().iloc[0,2]}
	...
	ccb1 = {'penyakit':sortbyfruit_is_ccb_aceh.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_aceh.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_ccb['Provinsi']=="Jawa Barat"
	sortbyfruit_is_ccb_jabar = sortbyfruit_is_ccb[is_jabar]
	ccb2 = {'penyakit':sortbyfruit_is_ccb_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_jabar.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_ccb['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_ccb_jateng = sortbyfruit_is_ccb[is_jateng]
	ccb3 = {'penyakit':sortbyfruit_is_ccb_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_jateng.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_ccb['Provinsi']=="Jawa Timur"
	sortbyfruit_is_ccb_jatim = sortbyfruit_is_ccb[is_jatim]
	ccb4 = {'penyakit':sortbyfruit_is_ccb_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_jatim.mode().iloc[0,2]}

	is_kalbar = sortbyfruit_is_ccb['Provinsi']=="Kalimantan Barat"
	sortbyfruit_is_ccb_kalbar = sortbyfruit_is_ccb[is_kalbar]
	ccb5 = {'penyakit':sortbyfruit_is_ccb_kalbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_kalbar.mode().iloc[0,2]}

	is_kalsel = sortbyfruit_is_ccb['Provinsi']=="Kalimantan Selatan"
	sortbyfruit_is_ccb_kalsel = sortbyfruit_is_ccb[is_kalsel]
	ccb6 = {'penyakit':sortbyfruit_is_ccb_kalsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_kalsel.mode().iloc[0,2]}

	is_kaltim = sortbyfruit_is_ccb['Provinsi']=="Kalimantan Timur"
	sortbyfruit_is_ccb_kaltim = sortbyfruit_is_ccb[is_kaltim]
	ccb7 = {'penyakit':sortbyfruit_is_ccb_kaltim.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_kaltim.mode().iloc[0,2]}

	is_lpg = sortbyfruit_is_ccb['Provinsi']=="Lampung"
	sortbyfruit_is_ccb_lpg = sortbyfruit_is_ccb[is_lpg]
	ccb8 = {'penyakit':sortbyfruit_is_ccb_lpg.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_lpg.mode().iloc[0,2]}

	is_sumut = sortbyfruit_is_ccb['Provinsi']=="Sumatra Utara"
	sortbyfruit_is_ccb_sumut = sortbyfruit_is_ccb[is_sumut]
	ccb9 = {'penyakit':sortbyfruit_is_ccb_sumut.mode().iloc[0,0],'provinsi':sortbyfruit_is_ccb_sumut.mode().iloc[0,2]}
	...
	gb1 = {'penyakit':sortbyfruit_is_gb_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_gb_jabar.mode().iloc[0,2]}
	...
	cl1 = {'penyakit':sortbyfruit_is_cl_btn.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_btn.mode().iloc[0,2]}

	is_diy = sortbyfruit_is_cl['Provinsi']=="DI Yogyakarta"
	sortbyfruit_is_cl_diy = sortbyfruit_is_cl[is_diy]
	cl2 = {'penyakit':sortbyfruit_is_cl_diy.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_diy.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_cl['Provinsi']=="Jawa Barat"
	sortbyfruit_is_cl_jabar = sortbyfruit_is_cl[is_jabar]
	cl3 = {'penyakit':sortbyfruit_is_cl_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_jabar.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_cl['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_cl_jateng = sortbyfruit_is_cl[is_jateng]
	cl4 = {'penyakit':sortbyfruit_is_cl_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_jateng.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_cl['Provinsi']=="Jawa Timur"
	sortbyfruit_is_cl_jatim = sortbyfruit_is_cl[is_jatim]
	cl5 = {'penyakit':sortbyfruit_is_cl_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_jatim.mode().iloc[0,2]}

	is_ntb = sortbyfruit_is_cl['Provinsi']=="Nusa Tenggara Barat"
	sortbyfruit_is_cl_ntb = sortbyfruit_is_cl[is_ntb]
	cl6 = {'penyakit':sortbyfruit_is_cl_ntb.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_ntb.mode().iloc[0,2]}

	is_ppa = sortbyfruit_is_cl['Provinsi']=="Papua"
	sortbyfruit_is_cl_ppa = sortbyfruit_is_cl[is_ppa]
	cl7= {'penyakit':sortbyfruit_is_cl_ppa.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_ppa.mode().iloc[0,2]}

	is_sulteng = sortbyfruit_is_cl['Provinsi']=="Sulawesi Tengah"
	sortbyfruit_is_cl_sulteng = sortbyfruit_is_cl[is_sulteng]
	cl8 = {'penyakit':sortbyfruit_is_cl_sulteng.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_sulteng.mode().iloc[0,2]}

	is_sumbar = sortbyfruit_is_cl['Provinsi']=="Sumatra Barat"
	sortbyfruit_is_cl_sumbar = sortbyfruit_is_cl[is_sumbar]
	cl9 = {'penyakit':sortbyfruit_is_cl_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_sumbar.mode().iloc[0,2]}

	is_sumsel = sortbyfruit_is_cl['Provinsi']=="Sumatra Selatan"
	sortbyfruit_is_cl_sumsel = sortbyfruit_is_cl[is_sumsel]
	cl10 = {'penyakit':sortbyfruit_is_cl_sumsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_cl_sumsel.mode().iloc[0,2]}
	...
	lf1 = {'penyakit':sortbyfruit_is_lf_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_lf_jatim.mode().iloc[0,2]}
	...
	mln1 = {'penyakit':sortbyfruit_is_mln_aceh.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_aceh.mode().iloc[0,2]}

	is_btn = sortbyfruit_is_mln['Provinsi']=="Banten"
	sortbyfruit_is_mln_btn = sortbyfruit_is_mln[is_btn]
	mln2 = {'penyakit':sortbyfruit_is_mln_btn.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_btn.mode().iloc[0,2]}

	is_jmb = sortbyfruit_is_mln['Provinsi']=="Jambi"
	sortbyfruit_is_mln_jmb = sortbyfruit_is_mln[is_jmb]
	mln3 = {'penyakit':sortbyfruit_is_mln_jmb.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_jmb.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_mln['Provinsi']=="Jawa Barat"
	sortbyfruit_is_mln_jabar = sortbyfruit_is_mln[is_jabar]
	mln4 = {'penyakit':sortbyfruit_is_mln_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_jabar.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_mln['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_mln_jateng = sortbyfruit_is_mln[is_jateng]
	mln5 = {'penyakit':sortbyfruit_is_mln_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_jateng.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_mln['Provinsi']=="Jawa Timur"
	sortbyfruit_is_mln_jatim = sortbyfruit_is_mln[is_jatim]
	mln6 = {'penyakit':sortbyfruit_is_mln_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_jatim.mode().iloc[0,2]}

	is_kalbar = sortbyfruit_is_mln['Provinsi']=="Kalimantan Barat"
	sortbyfruit_is_mln_kalbar = sortbyfruit_is_mln[is_kalbar]
	mln7 = {'penyakit':sortbyfruit_is_mln_kalbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_kalbar.mode().iloc[0,2]}

	is_kalsel = sortbyfruit_is_mln['Provinsi']=="Kalimantan Selatan"
	sortbyfruit_is_mln_kalsel = sortbyfruit_is_mln[is_kalsel]
	mln8 = {'penyakit':sortbyfruit_is_mln_kalsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_kalsel.mode().iloc[0,2]}

	is_kaltim = sortbyfruit_is_mln['Provinsi']=="Kalimantan Timur"
	sortbyfruit_is_mln_kaltim = sortbyfruit_is_mln[is_kaltim]
	mln9 = {'penyakit':sortbyfruit_is_mln_kaltim.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_kaltim.mode().iloc[0,2]}

	is_sumut = sortbyfruit_is_mln['Provinsi']=="Sumatra Utara"
	sortbyfruit_is_mln_sumut = sortbyfruit_is_mln[is_sumut]
	mln10 = {'penyakit':sortbyfruit_is_mln_sumut.mode().iloc[0,0],'provinsi':sortbyfruit_is_mln_sumut.mode().iloc[0,2]}
	...
	ppr1 = {'penyakit':sortbyfruit_is_ppr_bkl.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_bkl.mode().iloc[0,2]}

	is_jmb = sortbyfruit_is_ppr['Provinsi']=="Jambi"
	sortbyfruit_is_ppr_jmb = sortbyfruit_is_ppr[is_jmb]
	ppr2 = {'penyakit':sortbyfruit_is_ppr_jmb.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_jmb.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_ppr['Provinsi']=="Jawa Barat"
	sortbyfruit_is_ppr_jabar = sortbyfruit_is_ppr[is_jabar]
	ppr3 = {'penyakit':sortbyfruit_is_ppr_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_jabar.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_ppr['Provinsi']=="Jawa Timur"
	sortbyfruit_is_ppr_jatim = sortbyfruit_is_ppr[is_jatim]
	ppr4 = {'penyakit':sortbyfruit_is_ppr_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_jatim.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_ppr['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_ppr_jateng = sortbyfruit_is_ppr[is_jateng]
	ppr5 = {'penyakit':sortbyfruit_is_ppr_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_jateng.mode().iloc[0,2]}

	is_kaltim = sortbyfruit_is_ppr['Provinsi']=="Kalimantan Timur"
	sortbyfruit_is_ppr_kaltim = sortbyfruit_is_ppr[is_kaltim]
	ppr6 ={'penyakit':sortbyfruit_is_ppr_kaltim.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_kaltim.mode().iloc[0,2]}

	is_ntb = sortbyfruit_is_ppr['Provinsi']=="Nusa Tenggara Barat"
	sortbyfruit_is_ppr_ntb = sortbyfruit_is_ppr[is_ntb]
	ppr7 = {'penyakit':sortbyfruit_is_ppr_ntb.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_ntb.mode().iloc[0,2]}

	is_riau = sortbyfruit_is_ppr['Provinsi']=="Riau"
	sortbyfruit_is_ppr_riau = sortbyfruit_is_ppr[is_riau]
	ppr8 = {'penyakit':sortbyfruit_is_ppr_riau.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_riau.mode().iloc[0,2]}

	is_sulsel = sortbyfruit_is_ppr['Provinsi']=="Sulawesi Selatan"
	sortbyfruit_is_ppr_sulsel = sortbyfruit_is_ppr[is_sulsel]
	ppr9 = {'penyakit':sortbyfruit_is_ppr_sulsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_sulsel.mode().iloc[0,	2]}

	is_sumbar = sortbyfruit_is_ppr['Provinsi']=="Sumatra Barat"	
	sortbyfruit_is_ppr_sumbar = sortbyfruit_is_ppr[is_sumbar]
	ppr10 = {'penyakit':sortbyfruit_is_ppr_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_sumbar.mode().iloc[0,2]}

	is_sumsel = sortbyfruit_is_ppr['Provinsi']=="Sumatra Selatan"
	sortbyfruit_is_ppr_sumsel = sortbyfruit_is_ppr[is_sumsel]
	ppr11 = {'penyakit':sortbyfruit_is_ppr_sumsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_ppr_sumsel.mode().iloc[0,2]}
	...
	ptt1 = {'penyakit':sortbyfruit_is_ptt_btn.mode().iloc[0,0],'provinsi':sortbyfruit_is_ptt_btn.mode().iloc[0,2]}

	is_bkl = sortbyfruit_is_ptt['Provinsi']=="Bengkulu"
	sortbyfruit_is_ptt_bkl = sortbyfruit_is_ptt[is_bkl]
	ptt2 = {'penyakit':sortbyfruit_is_ptt_bkl.mode().iloc[0,0],'provinsi':sortbyfruit_is_ptt_bkl.mode().iloc[0,2]}

	is_diy = sortbyfruit_is_ptt['Provinsi']=="DI Yogyakarta"
	sortbyfruit_is_ptt_diy = sortbyfruit_is_ptt[is_btn]
	ptt3 = {'penyakit':sortbyfruit_is_ptt_diy.mode().iloc[0,0],'provinsi':sortbyfruit_is_ptt_diy.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_ptt['Provinsi']=="Jawa Barat"
	sortbyfruit_is_ptt_jabar = sortbyfruit_is_ptt[is_jabar]
	ptt4 = {'penyakit':sortbyfruit_is_ptt_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ptt_jabar.mode().iloc[0,2]}

	is_sumbar = sortbyfruit_is_ptt['Provinsi']=="Sumatra Barat"
	sortbyfruit_is_ptt_sumbar = sortbyfruit_is_ptt[is_sumbar]
	ptt5 = {'penyakit':sortbyfruit_is_ptt_sumbar.mode().iloc[0,0],'provinsi':sortbyfruit_is_ptt_sumbar.mode().iloc[0,2]}
	...
	tmt1 = {'penyakit':sortbyfruit_is_tmt_aceh.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_aceh.mode().iloc[0,2]}

	is_bali = sortbyfruit_is_tmt['Provinsi']=="Bali"
	sortbyfruit_is_tmt_bali = sortbyfruit_is_tmt[is_bali]
	tmt2 = {'penyakit':sortbyfruit_is_tmt_bali.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_bali.mode().iloc[0,2]}

	is_btn = sortbyfruit_is_tmt['Provinsi']=="Banten"
	sortbyfruit_is_tmt_btn = sortbyfruit_is_tmt[is_btn]
	tmt3 = {'penyakit':sortbyfruit_is_tmt_btn.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_btn.mode().iloc[0,2]}

	is_jmb = sortbyfruit_is_tmt['Provinsi']=="Jambi"
	sortbyfruit_is_tmt_jmb = sortbyfruit_is_tmt[is_jmb]
	tmt4 = {'penyakit':sortbyfruit_is_tmt_jmb.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_jmb.mode().iloc[0,2]}

	is_jabar = sortbyfruit_is_tmt['Provinsi']=="Jawa Barat"
	sortbyfruit_is_tmt_jabar = sortbyfruit_is_tmt[is_jabar]
	tmt5 = {'penyakit':sortbyfruit_is_tmt_jabar.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_jabar.mode().iloc[0,2]}

	is_jateng = sortbyfruit_is_tmt['Provinsi']=="Jawa Tengah"
	sortbyfruit_is_tmt_jateng = sortbyfruit_is_tmt[is_jateng]
	tmt6 = {'penyakit':sortbyfruit_is_tmt_jateng.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_jateng.mode().iloc[0,2]}

	is_jatim = sortbyfruit_is_tmt['Provinsi']=="Jawa Timur"
	sortbyfruit_is_tmt_jatim = sortbyfruit_is_tmt[is_jatim]
	tmt7 = {'penyakit':sortbyfruit_is_tmt_jatim.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_jatim.mode().iloc[0,2]}

	is_kalsel = sortbyfruit_is_tmt['Provinsi']=="Kalimantan Selatan"
	sortbyfruit_is_tmt_kalsel = sortbyfruit_is_tmt[is_kalsel]
	tmt8 = {'penyakit':sortbyfruit_is_tmt_kalsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_kalsel.mode().iloc[0,2]}

	is_ntb = sortbyfruit_is_tmt['Provinsi']=="Nusa Tenggara Barat"
	sortbyfruit_is_tmt_ntb = sortbyfruit_is_tmt[is_ntb]
	tmt9 = {'penyakit':sortbyfruit_is_tmt_ntb.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_ntb.mode().iloc[0,2]}

	is_sulsel = sortbyfruit_is_tmt['Provinsi']=="Sulawesi Selatan"
	sortbyfruit_is_tmt_sulsel = sortbyfruit_is_tmt[is_sulsel]
	tmt10 = {'penyakit':sortbyfruit_is_tmt_sulsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_sulsel.mode().iloc[0,2]}

	is_sulteng = sortbyfruit_is_tmt['Provinsi']=="Sulawesi Tengah"
	sortbyfruit_is_tmt_sulteng = sortbyfruit_is_tmt[is_sulteng]
	tmt11 = {'penyakit':sortbyfruit_is_tmt_sulteng.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_sulteng.mode().iloc[0,2]}

	is_sultgr = sortbyfruit_is_tmt['Provinsi']=="Sulawesi Tenggara"
	sortbyfruit_is_tmt_sultgr = sortbyfruit_is_tmt[is_sultgr]
	tmt12 = {'penyakit':sortbyfruit_is_tmt_sultgr.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_sultgr.mode().iloc[0,2]}

	is_sumsel = sortbyfruit_is_tmt['Provinsi']=="Sumatra Selatan"
	sortbyfruit_is_tmt_sumsel = sortbyfruit_is_tmt[is_sumsel]
	tmt13 = {'penyakit':sortbyfruit_is_tmt_sumsel.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_sumsel.mode().iloc[0,2]}

	is_sumut = sortbyfruit_is_tmt['Provinsi']=="Sumatra Utara"
	sortbyfruit_is_tmt_sumut = sortbyfruit_is_tmt[is_sumut]
	tmt14 = {'penyakit':sortbyfruit_is_tmt_sumut.mode().iloc[0,0],'provinsi':sortbyfruit_is_tmt_sumut.mode().iloc[0,2]}
